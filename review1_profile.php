...
if (isset($_GET['idreview1'])) {
    $idreview1 = $_GET['idreview1'];
    $sql = 'SELECT * from review1 WHERE idreview1="' . $idreview1 . '"';
...
$sql2 = 'SELECT * from review2 WHERE idreview1=' . $idreview1 . ' order by idreview2 desc';
        ...
        <div class="col-8">
            ...
            <div class="card">
                <div class="card-header text-white bg-info mb-3">
                    <?php echo "หัวข้อ : <a href='review1_profile.php?idreview1=" . $row['idreview1'] . "'>" . $row['topic'] . "</a>" ?>
                </div>
                <div class="card-body">
                    <!-- <h5 class="card-title"><?php// echo $row['topic']; ?></h5> -->
                    <p class="card-text">
                        <?php echo "<a href='review1_profile.php?idreview1=" . $row['idreview1'] . "'>" . $row['content'] . "</a>" ?>
                    </p>
                    <!-- <p class="card-text">
            ...
            <form name="comment" action="shopcomment_insert_process.php" method="post" class="form-horizontal">
                ...
                <input type="hidden" id="idreview" name="topic" value="<?php //echo $row['shop_name'] ?>">
                <input type="hidden" id="idreview" name="idmember" value="<?php //echo $idusername ?>">
...
<div class="container">
    <div class="row">
        <div class="col-md-8 mx-auto mt-5">
            <div class="card">
                <form action="review1_insert_process.php" method="POST" enctype="multipart/form-data">
...
while ($row2 = mysql_fetch_assoc($result2)) {
    ...
    echo "<h5 class='card-title'><a href='review2_profile.php?idreview2=" . $row2['idreview2'] . "'>" . $row2['topic'] . "</h5>";
    echo "<p class='card-text'> <a href='review2_profile.php?idreview2=" . $row2['idreview2'] . "'>" . $row2['content'] . "</a></p>";

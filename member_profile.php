...
if (isset($_GET['idmember'])) {
    ...
    //echo $idreview;
    $sql = 'SELECT * from member WHERE username="' . $idmember . '"';
    //echo $sql;
        ...
        <div class="col-8">
            ...
            <div class="card">
                <div class="card-header text-white bg-info mb-3">
                    <?php echo "ผู้รีวิว : <a href='member_profile.php?idmember=" . $row['username'] . "'>" . $row['username'] . "</a>" ?>
                </div>
                <div class="card-body">
                    <img width="200" height="200" src="Image/<?php echo $row['pic']; ?>" alt="..."
                        class="img-thumbnail">
                    <h5 class="card-title"><?php echo $row['fullname'] ?></h5>
                    <!-- <p class="card-text"><?php //echo $row['phone']."  ".echo $row['email'] ?></p> -->

                    <p class="card-text">
                        <?php echo "E-mail : " . $row['email'] ?></p>
                    <p class="card-text"><?php echo "โทรศัพท์ : " . $row['phone'] ?></p>

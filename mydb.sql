...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2020 at 07:59 AM
...
INSERT INTO `comment` (`idcomment`, `comment_content`, `datetime`, `idreview`) VALUES
(30, 'test', '2020-09-01 15:37:53', 6),
(31, 'test2', '2020-09-01 15:37:58', 6),
(32, 'ร้าน.คุณนาย', '2020-09-01 15:39:12', 6),
(33, 'test', '2020-09-01 15:46:12', 7),
(34, 'อร่อยมากน่าลอง', '2020-09-02 06:22:17', 10),
(35, 'ร้าน.ฮิมดอยหมูกระทะ อยู่ที่ไหน', '2020-09-02 10:50:38', 13),
(36, 'ฮิมดอยหมูกระทะสาขา5 อร่อยกว่า', '2020-09-02 14:49:45', 14);
...
CREATE TABLE `country` (
  ...
  `country_name_eng` varchar(255) NOT NULL,
...
INSERT INTO `country` (`idcountry`, `country_name_th`, `country_name_eng`, `idtype`) VALUES
(1, 'ประเทศไทย', 'Thailand', 1);

-- --------------------------------------------------------

--
-- Table structure for table `createreview`
--

CREATE TABLE `createreview` (
  `idcreatereview` int(11) NOT NULL,
  `crereview_topic` varchar(255) NOT NULL,
  `crereview_content` varchar(255) NOT NULL,
  `crereview_date` varchar(255) NOT NULL,
  `crereview_pic` varchar(255) NOT NULL,
  `crereview_username` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `createreview`
--

INSERT INTO `createreview` (`idcreatereview`, `crereview_topic`, `crereview_content`, `crereview_date`, `crereview_pic`, `crereview_username`) VALUES
(8, 'ส้มตำคาเฟ่', 'สำหรับใครที่กำลังมองหาแหล่งพักผ่อนในวันหยุดที่พร้อมตอบโจทย์ทุกความต้องการ วันนี้ Ryoiireview ขอพาแวะเช็คอินคาเฟ่ในพัทยากับร้าน ส้มตำคาเฟ่ by แซ่บอินเตอร์ (Sabinter) ร้านที่เกิดขึ้นจากการรวมตัวกันระหว่างคาเฟ่บรรยากาศดี และร้านอาหารอีสานสไตล์อินเตอร์! ขอแอบ', '2020-09-02 06:15:49', '', 'admin'),
(9, 'ก๋วยเตี๋ยวไก่มะระ', 'หากจะพูดถึงร้านก๋วยเตี๋ยวไก่ย่านท่าดินแดง ก็ไม่ควรพลาดกับร้านนี้เลยค่ะ \"ร้านก๋วยเตี๋ยวไก่ยายดำ\" ที่เปิดขายมามากกว่า 10 ปี ด้วยสูตรเครื่องเทศยาจีนสูตรลับ มาพร้อมไก่ตุ๋นยาจีนสูตรเด็ด ที่ใครได้เห็นได้ชิมก็ต้องกลับมาทานซ้ำอีกครั้ง จนกลายเป็นร้านก๋วยเตี๋ยวไก่ท', '2020-09-02 06:17:13', '', 'admin'),
(10, 'ข้าวขาหมู', 'ถ้าจะพูดถึงเมนูอาหารแนว Street food หลายๆ คนก็คงจะมีร้านอาหารในดวงใจกันใช่มั้ยคะ สำหรับวันนี้ Ryoiireview มีร้านเด็ดสไตล์สตรีทมาแนะนำให้แฟนเพจได้รู้จักกันค่ะ ร้านนี้ก็คือ “ข้าวขาหมูมันอยู่ในกระทะ” (เฮียเพ้ง ตรอกโรงหมู) ข้าวขาหมูร้านดังในตำนานอีกหนึ่งร้านท', '2020-09-02 06:18:10', '', 'admin'),
(11, 'เต้าหู้เย็นถังยี่', '  เห็นของหวานแล้วพาให้หัวใจเต้น หลายคนอาจคิดว่าเข้าร้านขนมหวานทั้งทีงานนี้อาจมีแคลอรี่เพิ่มกลับไป แต่ถ้าเลือกมาร้าน “เต้าหู้เย็นถังยี่” ที่มีเมนูขนมหวานเพื่อสุขภาพสูตรลับเฉพาะจากไต้หวัน เน้นความหวานน้อยเพื่อสายเฮลท์ตี้โดยเฉพาะบอกเลยต้องห้ามพลาดค่ะ ซึ่งสาข', '2020-09-02 06:18:47', '', 'admin'),
(12, 'ข้าวต้มปลา', '  เมื่อพูดถึงร้านเก่าแก่ร้านในตำนานสุดคลาสสิค ไม่ว่าพูดถึงกี่ครั้งก็ยังน่าสนใจ วันนี้ Ryoii จึงขอพาไปชิมร้านเซี่ยงกี่ข้าวต้มปลา ร้านข้าวต้มปลาในตำนานย่านเยาวราชที่เปิดมานานกว่า 90 ปี และมีการส่งต่อสูตรลับเฉพาะทายาทแบบรุ่นสู่รุ่นจากรุ่นอากงอาม่ามาสู่รุ่นหล', '2020-09-02 06:19:29', '', 'admin'),
(13, 'ฮิมดอยหมูกระทะเดียวนี้มีชาบูด้วย', 'อร่อยไปอีกแบบ', '2020-09-02 10:49:50', '', 'admin'),
(14, 'ฮิมดอยหมูกระทะสาขา4 ', 'ไปลองมาแล้ว', '2020-09-02 14:48:59', '', 'admin'),
(15, 'หมูกระทะ', 'อะไรก็ได้', '2020-09-02 15:00:49', '', 'admin');
...
INSERT INTO `geography` (`GEO_ID`, `GEO_NAME`, `idcountry`) VALUES
(1, 'ภาคเหนือ', 1),
(2, 'ภาคกลาง', 1),
...
INSERT INTO `member` (`idmember`, `username`, `password`, `fullname`, `email`, `phone`, `address`, `pic`) VALUES
(18, 'admin', 'admin', 'admin', 'admin@gmail.com', '0844796405', 'admin', 'img_5f438d93a32bd.jpg'),
(21, 'win', 'win', 'ชัยพิสิษฐ์ เรืองยศ', 'win@gmail.com', '0844796405', '328 หมู่ 8 ต.นากลาง อ.สูงเนิน จ.นครราชสีมา 30380', 'img_5f4910f003b72.jpg'),
(22, 'at', 'at', 'at', 'at@gmail.com', '0587965034', 'every where', 'img_5f51def29309b.jpg');
...
INSERT INTO `review` (`idreview`, `topic`, `content`, `datetime`, `pic`, `idmember`, `idshop`, `type`) VALUES
(35, 'ฮิมดอยหมูกระทะ', 'อร่อย wwwwin', '2020-09-01 09:43:04', '', 'admin', 23, ''),
(36, 'ฮิมดอยหมูกระทะ', 'www.google.com', '2020-09-01 09:49:29', '', 'admin', 23, ''),
(37, 'ฮิมดอยหมูกระทะ', 'ร้าน.ลุงหนวดอร่อยกว่า นะผมว่าอะ', '2020-09-01 10:06:52', '', 'admin', 23, ''),
(38, 'ฮิมดอยหมูกระทะ', 'ร้านลงพล', '2020-09-01 10:07:31', '', 'admin', 23, ''),
(39, 'ฮิมดอยหมูกระทะ', 'ร้านส้มตำ', '2020-09-02 07:48:57', '', 'admin', 23, ''),
(40, 'ฮิมดอยหมูกระทะ', 'ร้าน.ส้มตำ', '2020-09-02 07:49:10', '', 'admin', 23, ''),
(41, 'ฮิมดอยหมูกระทะสาขา4', 'ดีเหมือนกันลองมาแล้ว', '2020-09-02 10:51:58', '', 'admin', 26, ''),
(42, 'ฮิมดอยหมูกระทะสาขา4', 'ฮิมดอยหมูกระทะสาขา4  ผมก็ไปกินมาแล้วโอเค', '2020-09-02 10:55:27', '', 'admin', 26, ''),
(43, 'ฮิมดอยหมูกระทะสาขา4', 'ฮิมดอยหมูกระทะสาขา3 ไปมาแล้วรสชาติเดียวกัน', '2020-09-02 10:56:54', '', 'admin', 26, ''),
(44, 'ฮิมดอยหมูกระทะสาขา4', 'น่าลอง', '2020-09-02 14:45:14', '', 'admin', 26, ''),
(45, 'ฮิมดอยหมูกระทะสาขา4', 'หมูกระทะ', '2020-09-02 15:01:25', '', 'admin', 26, ''),
(46, 'ฮิมดอยหมูกระทะ', 'ร้านนี้ดีไปลองมาแล้ว', '2020-09-03 05:26:23', '', 'admin', 26, ''),
(48, 'น่าสนใจ', 'น่าสนใจ', '2020-09-03 08:16:10', '', 'admin', 26, ''),
(49, 'อยากลอง', 'อยากลอง', '2020-09-03 08:21:20', '', 'admin', 26, ''),
(51, 'ฮิมดอย', 'อร่อย', '2020-09-03 09:15:20', '', 'admin', 26, ''),
(52, 'กินกัน', 'กินกิน', '2020-09-03 09:39:18', '', 'admin', 26, ''),
(53, 'กินร้านนี้มาแล้ว', 'กิน', '2020-09-03 09:40:02', '', 'admin', 26, ''),
(54, 'กินร้านนี้มาแล้ว', 'กิน', '2020-09-03 09:40:57', '', 'admin', 26, ''),
(55, 'กินร้านนี้มาแล้ว', 'กินกินกัน', '2020-09-03 09:47:51', '', 'admin', 26, ''),
(56, 'อยากลองชิม', 'น่าอร่อยดี', '2020-09-04 05:40:39', '', 'admin', 22, ''),
(57, 'อยากไป', 'น่าสนใจ', '2020-09-04 08:07:41', '', 'admin', 32, 'สถานที่'),
(58, 'ถนนคนเดินท่าแพ', 'ไปมาแล้วนะสวยๆมากๆแนะนำแนะนำ', '2020-09-04 13:30:22', '', 'admin', 40, 'สถานที่');
...
INSERT INTO `review1` (`idreview1`, `topic`, `content`, `datetime`, `pic`, `username`, `type`, `idreview`, `idshop`) VALUES
(3, 'กิน', 'กิน', '2020-09-03 09:46:40', '', 'admin', '', 54, 26),
(4, 'อยากลอง', 'ลองลอง', '2020-09-03 09:48:08', '', 'admin', '', 55, 26),
(5, 'อร่อย', 'อร่อย', '2020-09-03 10:39:48', '', 'admin', '', 55, 26),
(7, 'อร่อย', 'มากๆๆ', '2020-09-03 15:20:24', '', 'admin', '', 55, 26),
(8, 'น่าสนใจ', 'อยากลอง', '2020-09-04 05:41:04', '', 'admin', '', 56, 22),
(9, 'ไปด้วย', 'ไปด้วย', '2020-09-04 08:08:01', '', 'admin', 'สถานที่', 57, 32),
(10, 'ถนนคนเดินท่าแพอยากไปๆ', 'อยากไปๆๆๆากด่นกดา่สกา่', '2020-09-04 13:31:42', '', 'admin', 'สถานที่', 58, 40),
(11, 'ไปด้วยถนนคนเดิน', 'ไปด้วยช่วยได้', '2020-09-04 13:32:06', '', 'admin', 'สถานที่', 58, 40);
...
INSERT INTO `review2` (`idreview2`, `topic`, `content`, `datetime`, `pic`, `username`, `type`, `idshop`, `idreview`, `idreview1`) VALUES
(4, 'กินร้านนี้มาแล้ว', 'น่าสนใจ', '2020-09-03 15:06:58', '', 'admin', '', 26, 55, 5),
(5, 'กินร้านนี้มาแล้ว', 'อร่อย', '2020-09-04 04:30:00', '', 'admin', '', 26, 55, 7),
(6, 'ลองบ้างสิ', 'น่าสนใจ', '2020-09-04 05:34:18', '', 'admin', '', 26, 55, 7),
(7, 'น่าสนใจ', 'กินด้วย', '2020-09-04 05:37:20', '', 'admin', '', 26, 55, 7),
(8, 'อร่อย', 'อร่อย', '2020-09-04 05:41:27', '', 'admin', '', 22, 56, 8),
(9, 'ลอง', 'ลอง', '2020-09-04 08:08:18', '', 'admin', 'สถานที่', 32, 57, 9);
...
CREATE TABLE `review3` (
  ...
  `idreview` int(11) DEFAULT NULL,
  `idshop` int(11) DEFAULT NULL,
  `idreview1` int(11) DEFAULT NULL,
  `idreview2` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `review3` (`idreview3`, `topic`, `content`, `datetime`, `pic`, `username`, `type`, `idreview`, `idshop`, `idreview1`, `idreview2`) VALUES
(1, 'กินร้านนี้มาแล้ว', 'อร่อย', '2020-09-04 05:39:16', '', 'admin', '', 55, 26, 7, 7),
(2, 'กินร้านนี้มาแล้ว', 'อร่อยจริงๆ', '2020-09-04 05:41:46', '', 'admin', '', 56, 22, 8, 8),
(3, 'ต้องไป', 'ให้ได้', '2020-09-04 08:08:39', '', 'admin', 'สถานที่', 57, 32, 9, 9);
...
CREATE TABLE `shop` (
  ...
  `shop_explain` text NOT NULL,
  `shop_country` varchar(255) NOT NULL,
  `shop_geography` varchar(255) NOT NULL,
  `shop_province` varchar(255) NOT NULL,
  `shop_amphur` varchar(255) NOT NULL,
  `shop_district` varchar(255) NOT NULL,
  `shop_village` varchar(255) NOT NULL,
...
INSERT INTO `shop` (`idshop`, `shop_name`, `shop_phone`, `shop_email`, `shop_explain`, `shop_country`, `shop_geography`, `shop_province`, `shop_amphur`, `shop_district`, `shop_village`, `shop_pic`, `shop_username`, `shop_type`) VALUES
(20, 'Tonnun', '0636663890', 'tonnun@gmail.com', 'อบอุ่น · ง่ายๆ สบายๆ · เหมาะสำหรับมาเป็นกลุ่ม', 'ประเทศไทย', 'ภาคเหนือ', 'อุตรดิตถ์', 'ท่าปลา', 'ท่าปลา', '0', 'img_5f477aa723c09.jpg', 'admin', 'อาหาร'),
(21, 'ร้านกาแฟ', '0995962961', 'shopC@gmail.com', 'ร้านกาแฟ ง่ายๆ สบายๆ · เหมาะสำหรับเด็ก · เหมาะสำหรับมาเป็นกลุ่ม', 'ประเทศไทย', 'ภาคเหนือ', 'แพร่', 'เมืองแพร่', 'ในเวียง', '0', 'img_5f4788cf4d984.jpg', 'admin', 'อาหาร'),
(22, 'ส้มตำศรีพารา', '0556443512', 'somtum@gmail.com', 'ร้านส้มตำที่อร่อยที่สุดในโลก อบอุ่น · ง่ายๆ สบายๆ · เหมาะสำหรับเด็ก', 'ประเทศไทย', 'ภาคเหนือ', 'อุตรดิตถ์', 'เมืองอุตรดิตถ์', 'ท่าอิฐ', '0', 'img_5f47895ecac58.jpg', 'admin', 'อาหาร'),
(23, 'ฮิมดอยหมูกระทะ', '0896452365', 'oingdory@gmail.com', 'ร้านหมูกะทะ อบอุ่น · ง่ายๆ สบายๆ · เหมาะสำหรับเด็ก', 'ประเทศไทย', 'ภาคเหนือ', 'อุตรดิตถ์', 'ท่าปลา', 'ท่าปลา  ', '0', 'img_5f478afe0217c.jpg', 'admin', 'อาหาร'),
(27, 'วัดพระธาตุดอยสุเทพ', '0896452365', 'somtum@gmail.com', 'วัดพระธาตุดอยสุเทพ วัดคู่บ้านคู่เมืองของชาวเชียงใหม่ที่ต้องแวะไปสักการะให้ได้เมื่อมาเยือนเชียงใหม่ วัดพระธาตุดอยสุเทพตั้งอยู่บนยอดดอยสุเทพโดยเราจะได้นมัสการพระบรมสารีริกธาตุของพระพุทธเจ้าเพื่อสิริมงคลแก่ชีวิต ด้วยการเดินขึ้นบันไดนาคไปสู่ตัววัดทั้งหมด 306 ขั้น แต่หากใครเดินขึ้นไม่ไหวก็มีบริการรถรางไฟฟ้าให้ด้วย', 'ประเทศไทย', 'ภาคเหนือ', 'เชียงใหม่', 'เมือง', 'สุเทพ', '', 'img_5f51c64566392.jpg', 'admin', 'สถานที่'),
(28, 'ดอยอ่างขาง', '0589463502', 'shopC@gmail.com', 'ดอยอ่างขางสถานที่ท่องเที่ยวทางธรรมชาติเชียงใหม่ที่เราจะได้สัมผัสอากาศเย็นๆ พร้อมชมดอกไม้ พืชผักเมืองหนาว ทะเลหมอก ดอกพญาเสือโคร่ง และอื่นๆ อีกมากมาย ซึ่งบนดอยอ่างขางนั้นมีสถานที่ท่องเที่ยวสำคัญหลายจุดให้เราได้ไปปักหมุดเช็คอินเพียบ', 'ประเทศไทย', 'ภาคเหนือ', 'เชียงใหม่', 'ฝาง', 'แม่งอน', '', 'img_5f51c884207c8.jpg', 'admin', 'สถานที่'),
(29, 'สวนสัตว์เชียงใหม่', '0985643258', 'cafee@gmailc.om', 'สวนสัตว์เชียงใหม่เป็นสวนสัตว์ขนาดใหญ่บนพื้นที่กว่า 531 ไร่ ที่มีสัตว์นานาชนิดกว่า 7,000 ตัว ให้เราได้ชมกัน ไม่ว่าจะเป็นสัตว์ยอดฮิตที่ต้องไปชมเมื่อมาถึงที่นี่อย่างหมีแพนด้า นกชนิดต่างๆ กว่า 800 ตัว นกเพนกวิน แมวนํ้า ชะนี สัตว์น้ำจืดกว่า 60 ชนิด ปลาบึกยักษ์ ฯลฯ ', 'ประเทศไทย', 'ภาคเหนือ', 'เชียงใหม่', 'เมือง', 'สุเทพ', '', 'img_5f51ca747b55e.jpg', 'admin', 'สถานที่'),
(31, 'วันนิมมาน', '0589463502', 'cafee@gmailc.om', 'วันนิมมานเรียกได้ว่าเป็นแลนด์มาร์คแห่งใหม่ของเชียงใหม่ที่ต้องรีบไปปักหมุดเช็คอินก่อนใครเพื่อน ที่นี่เป็นแหล่งรวมร้านค้า ศิลปะ วัฒนธรรม และความร่วมสมัยบนถนนนิมมานเหมินทร์ ภายในมีทั้งร้านอาหาร ร้านค้า ร้านกาแฟ แกลลอรี่', 'ประเทศไทย', 'ภาคเหนือ', 'เชียงใหม่', 'เมือง', 'สุเทพ', '', 'img_5f51d742f0ec8.jpg', 'admin', 'สถานที่'),
(32, 'แกรนด์แคนยอน', '0985643258', 'shopB@gmail.com', 'หากใครเป็นสายเอ็กซ์ตรีม ชื่นชอบการท่องเที่ยวแนวผจญภัยสุดท้าทายและได้เล่นน้ำด้วย แกรนด์แคนยอนเชียงใหม่ถือว่าเป็นที่เที่ยวเชียงใหม่ที่ตอบโจทย์สุดๆ เพราะที่นี่เป็นแอ่งน้ำขนาดใหญ่เหมือนแกรนด์แคนยอนที่รัฐแอริโซนา ประเทศสหรัฐอเมริกา', 'ประเทศไทย', 'ภาคเหนือ', 'เชียงใหม่', 'หางดง', 'น้ำแพร่', '', 'img_5f51d7f04b0e2.jpg', 'admin', 'สถานที่'),
(33, 'ยำวุ้นเส้นอัญชัน', '0985643258', 'shopB@gmail.com', '- เคล็ดลับการลวกวุ้นเส้น\r\nวุ้นเส้นที่จะนำไปทำยำจะไม่ควรนำไปแช่น้ำก่อน เพราะเมื่อนำไปลวก เส้นจะเปื่อยและพอง ก่อนลวกแค่น้ำไปล้างน้ำพอให้เส้นคลายออกจากกัน แล้วนำไปลวกพอนุ่ม ตักขึ้นแช่น้ำเย็นจัดพอหายร้อนแล้วสะเด็ดน้ำให้แห้งแล้วจึงนำไปยำ', '', '', '', '', '', '', 'img_5f51dbd658100.jpg', 'admin', 'อาหาร'),
(34, 'ส้มตำปู', '0896452365', 'shopC@gmail.com', 'เริ่มกันที่เมนูส้มตำปู อาหารอีสานสุดฮิต ใครอยากทำกินเองที่บ้านไปล้างครกรอเลยค่ะ สูตรนี้ไม่ใส่น้ำปลาร้าแต่ถ้าใครชอบน้ำปลาร้าก็จัดไป จับส่วนผสมทุกอย่างโขลก ๆ เข้าด้วยกัน แค่นี้ก็เรียบร้อย', '', '', '', '', '', '', 'img_5f51dc6653466.jpg', 'admin', 'เมนูอาหาร'),
(35, 'ส้มตำถั่วฝักยาว', '0985643258', 'cafee@gmailc.om', 'ถ้าเบื่อเมนูส้มตำใส่มะละกอก็มากินเมนูส้มตำถั่วฝักยาว สูตรจาก คุณ Kitty Chef สมาชิกเว็บไซต์พันทิปดอทคอม สูตรนี้ใส่ถั่วฝักยาวลายเสือลงไปเคล้า ที่ขาดไม่ได้เลยคือ น้ำปลาร้า กินกับไข่ต้มหรือแคบหมูก็เลิศค่ะ', '', '', '', '', '', '', 'img_5f51dd0076446.jpg', 'admin', 'เมนูอาหาร'),
(36, 'ส้มตำข้าวโพด', '0985643258', 'cafee@gmailc.om', 'และแล้วก็มาถึงเมนูร้านส้มตำยอดนิยมที่รอคอยนั่นคือเมนูส้มตำข้าวโพด สูตรจาก คุณ Angelisa สมาชิกเว็บไซต์พันทิปดอทคอม จะใช้ข้าวโพดหวานหรือข้าวโพดข้าวเหนียวก็ตามชอบ เพิ่มสีสันจากมะเขือเทศ แครอท และถั่วฝักยาว โรยถั่วเยอะ ๆ เคี้ยวเพลิน ', '', '', '', '', '', '', 'img_5f51dd44a2749.jpg', 'admin', 'เมนูอาหาร'),
(37, 'ลาบเป็ด', '0985643258', 'shopB@gmail.com', 'ลาบเป็ดทั่วไปคงต้องชิดซ้ายให้กับลาบเป็ด สูตรจาก คุณ isolateboy สมาชิกเว็บไซต์พันทิปดอทคอม สูตรนี้มีทั้งเนื้อเป็ดและเครื่องในเป็ด แถมยังใส่เครื่องสมุนไพรเน้น ๆ แบบนี้ต้องเบิ้ล', '', '', '', '', '', '', 'img_5f51ddd951b64.jpg', 'admin', 'อาหาร'),
(38, 'ไก่ย่างพริกไทยดำ', '0985643258', 'shopB@gmail.com', ' เริ่มต้นด้วยสูตรไก่ย่างยอดนิยมอย่างไก่ย่างพริกไทยดำจาง ๆ กลิ่นหอม และมีรสเผ็ดเล็ก ๆ วิธีทำก็ง่าย ๆ แค่โขลกกระเทียม พริกไทยดำ และรากผักชี แล้วเอาไปหมักกับไก่พร้อมด้วยซอสปรุงรสอีกนิด แช่ในตู้เย็นอย่างน้อย 1 ชั่วโมง เสร็จแล้วก็เอาออกมาย่าง หรืออบ เพียงเท่านี้ก็เรียบร้อย ', '', '', '', '', '', '', 'img_5f51de407a4f9.jpg', 'admin', 'เมนูอาหาร'),
(39, 'ไก่ย่างสไปซี่ ', '0985643258', 'shopB@gmail.com', ' ไก่ย่างสไปซี่ สูตรไก่ย่างรสเผ็ดจี๊ดจ๊าด ส่วนผสมที่ใช้หมักเพิ่มรสเผ็ดคือ ปาปริก้า และใส่พริกไทยเพิ่มความหอมลงไปหน่อย เหมาะเป็นอาหารทานเล่นหรือกับแกล้มในงานปาร์ตี้มาก ๆ เลยค่ะ หรือทำขายตามแหล่งชุมชนก็ได้ อาจเปลี่ยนจากสะโพกไก่เป็นน่องไก่เล็ก ๆ ลูกค้าจะได้หยิบจับง่ายถนัดมือด้วย', '', '', '', '', '', '', 'img_5f51de917df0d.jpg', 'admin', 'เมนูอาหาร'),
(40, 'ถนนคนเดินท่าแพ', '0985643258', 'shopB@gmail.com', 'ถนนคนเดินท่าแพ ถนนที่เพื่อนๆ จะได้สัมผัสวิถีชีวิตและความเป็นพื้นเมืองของชาวเชียงใหม่ยามค่ำคืนได้อย่างใกล้ชิด บริเวณถนนคนเดินแห่งนี้เราจะได้ชิม ช้อป ชิล ทั้งอาหาร Street Food ขึ้นชื่อ ผลไม้พื้นเมือง ได้ช้อปสินค้า Handmade สินค้าแฟชั่น ซื้อของฝากจากเชียงใหม่ไปให้คนใกล้ชิด โดยถนนคนเดินท่าแพจะเริ่มจากประตูเมืองท่าแพไปจนสุดถนนราชดำเนิน เรียกได้ว่าเดินชิล เดินช้อป เดินกินกันจนอิ่มเลยทีเดียว', 'ประเทศไทย', 'ภาคเหนือ', 'เชียงใหม่', 'เมือง', 'ศรีภูมิ', '', 'img_5f5224f9a1022.jpg', 'admin', 'สถานที่');
...
CREATE TABLE `shopcomment` (
  `idshopcomment` int(11) NOT NULL,
  `shopcomment_content` text NOT NULL,
  `shopcomment_datetime` datetime NOT NULL,
  `idshop` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `shopcomment` (`idshopcomment`, `shopcomment_content`, `shopcomment_datetime`, `idshop`) VALUES
(1, 'ร้านนี้อร่อย', '2020-08-23 10:12:55', 7),
(2, 'น้องเปิ้ลน่ารัก', '2020-08-23 11:29:38', 7),
(3, 'แหนมอร่อย', '2020-08-23 13:13:40', 10);
...
CREATE TABLE `type` (
  ...
  `type_name_eng` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `type` (`idtype`, `type_name_th`, `type_name_eng`) VALUES
(1, 'อาหาร', 'food');
...
--
-- Indexes for table `createreview`
--
ALTER TABLE `createreview`
  ADD PRIMARY KEY (`idcreatereview`);
...
--
ALTER TABLE `review1`
  ADD PRIMARY KEY (`idreview1`);

--
-- Indexes for table `review2`
--
ALTER TABLE `review2`
  ADD PRIMARY KEY (`idreview2`);

--
-- Indexes for table `review3`
--
ALTER TABLE `review3`
  ADD PRIMARY KEY (`idreview3`);
...
--
-- AUTO_INCREMENT for table `createreview`
--
ALTER TABLE `createreview`
  MODIFY `idcreatereview` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `review`
  MODIFY `idreview` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `review1`
--
ALTER TABLE `review1`
  MODIFY `idreview1` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `review2`
--
ALTER TABLE `review2`
  MODIFY `idreview2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `review3`
--
ALTER TABLE `review3`
  MODIFY `idreview3` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `shop`
--
ALTER TABLE `shop`
  MODIFY `idshop` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `shopcomment`
--
ALTER TABLE `shopcomment`
  MODIFY `idshopcomment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

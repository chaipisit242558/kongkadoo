...
// $sql2 = 'SELECT * from shopcomment WHERE idshop=' . $idshop . '';
// //echo $sql2;
        ...
        <div class="col-8">
            ...
            <div class="card">
                <div class="card-header text-white bg-info mb-3">
                    <?php echo "ชื่อร้าน : " . $row['shop_name']; ?>
                </div>
                <div class="card-body">
                    <!-- <h5 class="card-title"><?php// echo $row['topic']; ?></h5> -->
                    <p class="card-text"><?php echo $row['shop_explain']; ?></p>
                    <p class="card-text"><?php echo $row['shop_phone'] . "  " . $row['shop_email']; ?></p>
                    <!-- <p class="card-text"><?php// echo $row['shop_email']; ?></p> -->
            ...
            <p>
                ...
                <!-- <form name="comment" action="manage_review.php" method="post" class="form-horizontal">
                ...
                <a class="btn btn-primary" href="manage_review.php?idshop=<?php echo $idshop ?> >"
                    role="button">แสดงความคิดเห็น</a>
            </p>
...
//     echo "<p class='card-text'>" . $row2['shopcomment_content'] . "</p>";

...
//echo $username;
$sql = "insert into  review2 (topic,content,datetime,pic,username,type,idreview,idshop,idreview1)";
$sql .= "values('" . $topic . "','" . $tarcomment . "','" . $date . "','','" . $username . "','" . $type . "','" . $idreview . "','" . $idshop . "','" . $idreview1 . "')";
...
echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=review1_profile.php?idreview1=$idreview1'>";